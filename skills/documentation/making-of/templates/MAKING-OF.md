...
three beats, and the goal above and the proof here should point at the same test, red then
green:

Before this existed, running the test for it looked like this:
...
means the behavior is correct>. Running it now:
